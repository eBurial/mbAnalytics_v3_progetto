 ...
 * ovvero quello del cerchio velocitÃ 
 */

// Costruttore
function CircleSpeedExerciseChart(jsonData, exerciseType, sessionID) {
	...
	this.jsonHeaderData.forEach(function(d) {
		...
		d.turnsInside = +d.turnsInside;
		d.totalSpeed = +d.totalSpeed;
		d.distanceCorrect = +d.distanceCorrect;
		d.centerCircle = +d.centerCircle;
			
		// Calcolo
		d.deviationIndex = (d.distanceCorrect - d.centerCircle) / 
		 									 (d.distanceCorrect + d.centerCircle);
	...
	var groupedBarChart = 
		new GroupedBarChart(dataHeader, 
												["accuracy", "turnsInside", "distanceCorrect", "totalSpeed"],
												sessionID,
...
CircleSpeedExerciseChart.prototype.createSvgN = function(sessionNumber) {
...
CircleSpeedExerciseChart.prototype.createCircleN = function(svg) {
...
CircleSpeedExerciseChart.prototype.createLinePath = function(svg, dataVal, x, y, color) {
...
CircleSpeedExerciseChart.prototype.createDotPath = function(svg, dataVal, x, y, color, index) {
...
CircleSpeedExerciseChart.prototype.createTextInfo = function(dataH, sessionNumber) {
...
//	}
	...
	var variabili = ["accuracy", "turnsInside", "distanceCorrect", "totalSpeed", "deviationIndex"];
...
CircleSpeedExerciseChart.prototype.getAverageHeader = function(dataH) {
	    
	var sumDataH = { accuracy: 0, turnsInside: 0, totalSpeed: 0,
									 distanceCorrect: 0, deviationIndex: 0};
	dataH.forEach(function(d) {
		sumDataH.accuracy += d.accuracy;
		sumDataH.turnsInside += d.turnsInside;
		sumDataH.totalSpeed += d.totalSpeed;
		sumDataH.distanceCorrect += d.distanceCorrect;
		sumDataH.deviationIndex += (d.distanceCorrect - d.centerCircle) / 
		 													 (d.distanceCorrect + d.centerCircle);
	});
	
	sumDataH.accuracy = sumDataH.accuracy / 3;
	sumDataH.turnsInside = sumDataH.turnsInside / 3;
	sumDataH.totalSpeed = sumDataH.totalSpeed / 3;
	sumDataH.distanceCorrect = sumDataH.distanceCorrect  / 3;
...
CircleSpeedExerciseChart.prototype.showSvgRealDimensions = function(sessionNumber) {
