...
// Costruttore
function FourTargetExerciseChart(jsonData, exerciseType, sessionID) {
...
FourTargetExerciseChart.prototype.createSvgN = function(sessionNumber) {
...
FourTargetExerciseChart.prototype.getArrayTargetCoordN = function() {
	...
	coordinateTarget.push({x: this.x(this.x3 / this.screenWidth),
		 										 y: this.y(this.y3 / this.screenHeight)});
	coordinateTarget.push({x: this.x(this.x4 / this.screenWidth),
...
FourTargetExerciseChart.prototype.getArrayTargetCoord = function() {
	var coordinateTarget = []; 
	coordinateTarget.push({x: this.x1, y: this.y1});
	coordinateTarget.push({x: this.x2, y: this.y2});
	coordinateTarget.push({x: this.x3, y: this.y3});
	coordinateTarget.push({x: this.x4, y: this.y4});
	
	return coordinateTarget;
}

// Crea il quadrato "obiettivo" in base alle coordinate e al contenitore passato
FourTargetExerciseChart.prototype.createTargets = function(svg, arrayCoordTarget, strokeWidth, index) {
...
FourTargetExerciseChart.prototype.createInvisibleTargets = function(svg, arrayCoordTarget, strokeWidth, index) {
...
FourTargetExerciseChart.prototype.createDotPath = function(svg, dataVal, x, y, color, index) {
...
FourTargetExerciseChart.prototype.createTextInfo = function(dataH, sessionNumber) {
...
FourTargetExerciseChart.prototype.getAverageHeader = function(dataH) {
...
FourTargetExerciseChart.prototype.showSvgRealDimensions = function(sessionNumber) {
